...
# <p><em><sup>2</sup> Well, it turned out to be volatile indeed :D</em></p>
# <p>That said, let's get to business. (NOTE: The public API went private in 2020 and is no longer available) named <code>datasets/coinmarketcap_06122017.csv</code>. </p>
